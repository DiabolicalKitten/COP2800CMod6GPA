...
public class PalmerPenguinsM6 {
    ...
    *          as a parameter and returns true if its length is 0, otherwise 
    *          false.
    */
   public static boolean isDataEmpty(String[] array) {
    ...
    *          This method should iteratethrough speciesData and 
    *          update speciesCount accordingly.
    */
   public static void countSpecies(String[] speciesData, int[] speciesCount) {

       for (int i = 0; i < speciesData.length; i++) {

           String species = speciesData[i];
...
class CSVReader {
    /**
     * readFile reads a file line by line, extracts the  
     * specified column from each line,
